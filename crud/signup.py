...
button2= customtkinter.CTkButton(master=frame, text="Forgot Password", width=150, height=20, compound="left", fg_color='white', text_color='black', hover_color='#AFAFAF')
button2.place(x=50, y=205)
