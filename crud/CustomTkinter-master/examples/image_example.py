...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text=" Attendance System", image=self.logo_image,
...
#--------------------------------------------------
        ...
        '''self.home_frame_button_5 = customtkinter.CTkButton(self.home_frame, text="CTkButton", image=self.image_icon_image, compound="bottom", anchor="w")
        ...
        self.about_us_frame_1 = customtkinter.CTkFrame(master=self.about_us_frame, width= 720, height = 360)
        self.about_us_frame_1.grid(row=0, column=0, padx=500, pady=87)
        self.about_us_frame_label=customtkinter.CTkLabel(master=self.about_us_frame_1, text="Log into your Account",font=('Century Gothic',20))
